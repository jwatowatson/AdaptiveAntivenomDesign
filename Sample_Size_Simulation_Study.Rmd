...
N_max = 100 # Maximum number of patients recruited
...
f_true_tox = approxfun(x = c(1:true_MTD,(true_MTD):(4*true_MTD)), 
                       y = c(seq(0,MTT,length.out = true_MTD),
                             seq(MTT,1,length.out = length((true_MTD):(4*true_MTD)))), 
                       rule = 2)
f_true_eff = approxfun(x = c(1:true_TED,(true_TED):(true_TED+10)), 
                       c(seq(0,TEL,length.out = true_TED),seq(TEL,1,length.out = 11)), rule = 2)
...
f_true_tox = approxfun(x = c(1, 400), 
                       y = c(.2, .2), rule = 2)
f_true_eff = approxfun(x = c(8, 20, true_TED, 400), y = c(0, .5, TEL,1), rule = 2)
true_model = list(tox = f_true_tox, eff = f_true_eff)
model_params_true = NULL
tic()
